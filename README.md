...
const config = {
  ...
  photoSrc: "./assets/graduation-chuhieu03.png",
};
```
...
1. Tạo repo `chuhieu03-graduation` (hoặc tên bất kỳ).
...
2. Đặt file `og-chuhieu03-graduation.png` (kích thước **1200 × 630**) vào thư mục `assets/`.
